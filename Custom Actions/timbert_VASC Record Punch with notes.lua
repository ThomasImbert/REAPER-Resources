...
local save_item_slot_1_ID = reaper.NameCommandLookup("_SWS_SAVESELITEMS1") 
-- Get computer specific ID of "SWS: Restore Selected track(s) selected item(s), slot 1"
local restore_item_slot_1_ID = reaper.NameCommandLookup("_SWS_RESTSELITEMS1") 
-- Get computer specific ID of "_SWS_SAVESEL"
local sws_saveCurrentTrackSelection = reaper.NameCommandLookup("_SWS_SAVESEL") 
-- Get computer specific ID of "timbert_VASC Select Guide track exclusively.lua"
local vasc_selectGuideTrack = reaper.NameCommandLookup("_RS09aad089649d67d41b3553419bbc062570f69fe7")
-- Get computer specific ID of "_SWS_RESTORESEL"
local sws_restoreTrackSelection = reaper.NameCommandLookup("_SWS_RESTORESEL")  
-- Get computer specific ID of "timbert_Store selected item notes.lua"
local vasc_storeItemNotes = reaper.NameCommandLookup("_RS71a88093363c7138ff37c985534487b02a6738d4") 
-- Get computer specific ID of "Script: timbert_Paste to selected item notes.lua"
local vasc_pasteItemNotes = reaper.NameCommandLookup("_RS465de87b16682226804d7b9d85cf79e17e6d92e7") 
-- Get computer specific ID of "_XENAKIOS_SELITEMSUNDEDCURSELTX"
local sws_selectItems_editCursor_onSelectedTracks = reaper.NameCommandLookup("_XENAKIOS_SELITEMSUNDEDCURSELTX") 
-- Get computer specific ID of "_SWS_SAVEALLSELITEMS1"
local sws_saveSelectedItems = reaper.NameCommandLookup("_SWS_SAVEALLSELITEMS1") 
-- Get computer specific ID of "_SWS_RESTALLSELITEMS1"
local sws_restoreSelectedItems = reaper.NameCommandLookup("_SWS_RESTALLSELITEMS1") 
-- Get computer specific ID of "tt"
local name2 = reaper.NameCommandLookup("tt") 
